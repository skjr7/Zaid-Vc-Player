...
ASSID = int(getenv("ASSID","5552498817"))
ASSNAME = getenv("ASSNAME",)
ASSUSERNAME = getenv("ASSUSERNAME","one_love_tj)
BOT_ID = int(getenv("BOT_ID","5396553905"))
...
OWNER_ID = int(getenv("OWNER_ID","5429873872"))
UPDATE = getenv("UPDATE", "one_love_support")
SUPPORT = getenv("SUPPORT", "Tamil_chat_junctions")
